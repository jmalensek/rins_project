...
pkg_rins_project = get_package_share_directory('rins_project')
...
def generate_launch_description():    
    # Launch Files
    gazebo_launch = PathJoinSubstitution([pkg_rins_project, 'launch', 'sim.launch.py'])
    robot_spawn_launch = PathJoinSubstitution([pkg_rins_project, 'launch', 'turtlebot4_spawn.launch.py'])
    localization_launch = PathJoinSubstitution([pkg_rins_project, 'launch', 'localization.launch.py'])
    nav2_launch = PathJoinSubstitution([pkg_rins_project, 'launch', 'nav2.launch.py'])
