...
pkg_task1 = get_package_share_directory('task1')
...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('map', default_value=PathJoinSubstitution([pkg_task1, 'maps', 'bird_demo.yaml']), description='Full path to map yaml file to load')
]
...
def generate_launch_description():    
    # Launch Files
    gazebo_launch = PathJoinSubstitution([pkg_task1, 'launch', 'sim.launch.py'])
    robot_spawn_launch = PathJoinSubstitution([pkg_task1, 'launch', 'turtlebot4_spawn.launch.py'])
    localization_launch = PathJoinSubstitution([pkg_task1, 'launch', 'localization.launch.py'])
    nav2_launch = PathJoinSubstitution([pkg_task1, 'launch', 'nav2.launch.py'])
